...
public class EmailService {
    ...
    public void enviarEmailPessoaSemEndereco(String destinatario, String nome) throws MessagingException, IOException, TemplateException {
        MimeMessage mimeMessage = emailSender.createMimeMessage();
        ...
        helper.setFrom(remetente);
        helper.setTo(destinatario);
        helper.setSubject("Adicione o seu endereço");

        Template template = configuration.getTemplate("email-template-pessoa-sem-endereco.ftl");
        Map<String, Object> dados = new HashMap<>();
        dados.put("nome", nome);
        String html = FreeMarkerTemplateUtils.processTemplateIntoString(template, dados);
    ...
    public void enviarEmailPromocaodeNatal(String destinatario, String nome) throws MessagingException, IOException, TemplateException {
        MimeMessage mimeMessage = emailSender.createMimeMessage();
        ...
        helper.setFrom(remetente);
        helper.setTo(destinatario);
        helper.setSubject("Promoção de Natal");

        Template template = configuration.getTemplate("email-template-promocao-de-natal.ftl");
        Map<String, Object> dados = new HashMap<>();
        dados.put("nome", nome);
        String html = FreeMarkerTemplateUtils.processTemplateIntoString(template, dados);
